...
<nav>
  ...
  <div class="article">
    ...
    <ul>
      <li>
        <a href="#sharing-a-story-from-screenshots">
      ...
      <li>
        ...
        <ul>
          <li>
            <a href="#initial-master-view-detail-layout-with-drag-and-drop-listview">
      ...
      <li>
        ...
        <ul>
          <li>
            <a href="#initializing-the-app-controller">
          ...
          <li>
            <a href="#deleting-items">
              Deleting Items
            </a>
          </li>
          <li>
            <a href="#arranging-image-items-via-more-drag-and-drop">
              Arranging Image Items via More Drag and Drop
            </a>
            <ul>
              <li>
                <a href="#cell-drag-and-drop-implementation">
                  Cell Drag and Drop Implementation
                </a>
              </li>
              <li>
                <a href="#controller-update">
                  Controller Update
                </a>
              </li>
              <li>
                <a href="#app-css-styles">
                  App CSS Styles
                </a>
              </li>
              <li>
                <a href="#order-of-the-presentation-slides">
      ...
      <li>
        <a href="#view-detail-and-app-domain">
          View Detail and App Domain
        </a>
        <ul>
          <li>
            <a href="#refactorizations-on-data-and-ui">
          ...
          <li>
            <a href="#reusing-enums-by-converting-them-into-english-strings">
      ...
      <li>
        <a href="#view-pane-and-drawing">
          View Pane and Drawing
        </a>
        <ul>
          <li>
            <a href="#drawing-package">
              Drawing Package
            </a>
          </li>
          <li>
            ...
            <ul>
              <li>
                <a href="#updating-the-controller-with-the-drawing-view">
      ...
      <li>
        <a href="#code-snippet-slide">
          Code Snippet Slide
        </a>
        <ul>
          <li>
            <a href="#adding-a-new-empty-slide">
              Adding a New Empty Slide
            </a>
          </li>
          <li>
            <a href="#updating-the-model-with-the-slide-language-and-caption">
              Updating the Model with the Slide Language and Caption
            </a>
          </li>
          <li>
            <a href="#code-shot-slide">
              Code Shot Slide
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#code-snippet-drawing">
              Code Snippet Drawing
            </a>
            <ul>
              <li>
                <a href="#rendering-captions">
                  Rendering Captions
                </a>
              </li>
              <li>
                <a href="#putting-the-drawing-together">
      ...
      <li>
        <a href="#drawing-shapes">
          Drawing Shapes
        </a>
      </li>
      <li>
        <a href="#integrating-ai-via-ocr">
          Integrating AI via OCR
        </a>
      </li>
      <li>
        <a href="#designing-an-auto-save-mechanism">
          Designing an Auto Save Mechanism
        </a>
      </li>
      <li>
        <a href="#automation-of-screenshots-and-code-snippets-content">
